...
struct GeneratingProcessView: View {
    ...
    @State private var glowRadius: CGFloat = 10.0
    var body: some View {
        ZStack {
            VStack {
                HStack {
                                                ...
                                                if !finishKey {
                                                    ...
                                                    Task {
                                                        do {
                                                            ...
                                                            try await storyViewModel.uploadStoryToFirestore(storyTextItem: storyTextItem, childId: childId, title: title.trimmingCharacters(in: .newlines), genre: genre, theme: theme, mood: mood, summary: summary)
                                        ...
                                        ZStack {
                                            ...
                                            Text(currentText)
                                              ...
                                              //  .background(colorScheme == .dark ? .black.opacity(0.5) : .white.opacity(0.5))
                                                ...
                                                .shadow(radius: 7)
                                                .onAppear {
                                                                            // Animate glow effect (pulsating shadow)
                                        ...
                                        withAnimation(.easeIn(duration: 2)) {
                                                        ...
                                                        DispatchQueue.main.asyncAfter(deadline: .now() + 2) {
                                                            ...
                                                            randomPosition = CGPoint(x: CGFloat.random(in: 150...(UIScreen.main.bounds.width * 0.9 - 150)),
                                                                                     y: CGFloat.random(in: 150...(isExpanding ? (oriantation.isLandscape ? UIScreen.main.bounds.height * 0.9 : UIScreen.main.bounds.width * 0.9) : (oriantation.isLandscape ? UIScreen.main.bounds.height * 0.5 : UIScreen.main.bounds.width * 0.7) * 0.9 - 150)))
