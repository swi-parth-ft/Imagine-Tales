  ...
  @State private var selectedEmoji = ""
    ...
    func generateImagePrompt() async throws {
        ...
        if isGeneratingCover {
            ...
            The background should reflect \(theme), with elements like [insert any key features from the scene like glowing trees, fireflies, etc.]. Make sure the mood of the illustration reflects \(mood) and \(genre), based on the story. Keep the design toy-like, with smooth and rounded features to appeal to children. There should be no text in the image.
            """
            generateImageUsingOpenAI()
            print(promptForImage)
