                                            ...
                                            HStack {
                                                Button {
                                                    ...
                                                    Text("Male")
                                                        ...
                                                        .background(colorScheme == .dark ? (viewModel.gender == "Male" ? Color(hex: "#FF6F61") : .black.opacity(0.2)) : (viewModel.gender == "Male" ? Color(hex: "#FF6F61") : .white))
                                                        .cornerRadius(isCompact ? 6 : 12)
                                                }
                                                ...
                                                Button {
                                                    ...
                                                    Text("Female")
                                                        ...
                                                        .foregroundStyle(colorScheme == .dark ? .white : .black)
                                                        .frame(width: UIScreen.main.bounds.width * 0.34, height: isCompact ? 35 : 55)
                                                        .background(colorScheme == .dark ? (viewModel.gender == "Female" ? Color(hex: "#FF6F61") : .black.opacity(0.2)) : (viewModel.gender == "Female" ? Color(hex: "#FF6F61") : .white))
                                                        .cornerRadius(isCompact ? 6 : 12)
                                                }
                                            ...
                                            VStack(alignment: .leading) {
                                                        ...
                                                        HStack {
                                                            ...
                                                            Button(action: {
                                                                ...
                                                                HStack {
                                                                    Text(viewModel.country) // Display the selected country
                                                            ...
                                                            ScrollView{
                                                                VStack(alignment: .leading, spacing: 5) {
                                                                    ForEach(countries, id: \.self) { co in
                                                                        Button(action: {
                                                                            viewModel.country = co // Set the selected country
